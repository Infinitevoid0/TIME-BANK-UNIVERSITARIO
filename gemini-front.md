...
* **AtividadeFormModal:**
    ...
    * **Aviso de Moderação Obrigatória:** O formulário deve renderizar um aviso fixo (exceto no modo correção) informando ao aluno que toda atividade ofertada, com ou sem disciplina, exige aprovação da moderação.
